...
model = dict(
    ...
    roi_head=dict(
        type='PP_StandardRoIHead_2',
        bbox_roi_extractor=dict(
            # type='PP_SingleRoIExtractor',
            type='SingleRoIExtractor',
            roi_layer=dict(type='RoIAlign', output_size=7, sampling_ratio=0),
            out_channels=256,
            featmap_strides=[4, 8, 16, 32]),
        bbox_head=dict(
            # type='PP_Shared2FCBBoxHead', ##Extract 1024-dim features
            type='PP_CosineSimBBoxHead',
            in_channels=256,
            ...
            loss_cls=dict(
                type='MARGIN_CrossEntropyLoss', use_sigmoid=False, use_margin_cls=True, loss_weight=1.0),
