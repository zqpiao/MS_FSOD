...
data = dict(
    ...
    train=dict(
        ...
        save_dataset=True,
        ann_cfg=[dict(method='FSCE', setting='SPLIT1_SEED0_1SHOT')],
...
load_from = 'work_dirs/fsce_r101_fpn_voc-split1_1shot-fine-tuning_seed0_mixing/epoch_50.pth'
# load_from = 'work_dirs/fsce_r101_fpn_voc-split1_1shot-fine-tuning_seed0_energy_mixup/iter_1000.pth'
