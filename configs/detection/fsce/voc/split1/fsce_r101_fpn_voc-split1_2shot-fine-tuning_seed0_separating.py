...
data = dict(
    ...
    train=dict(
        ...
        save_dataset=True,
        ann_cfg=[dict(method='FSCE', setting='SPLIT1_SEED0_2SHOT')],
...
# load_from = 'work_dirs/fsce_r101_fpn_voc-split1_2shot-fine-tuning_seed0_energy_mixup/epoch_50.pth'
load_from = 'work_dirs/fsce_r101_fpn_voc-split1_2shot-fine-tuning_seed0_mixing/iter_2000.pth'
