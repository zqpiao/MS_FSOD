...
data = dict(
    ...
    train=dict(
        ...
        save_dataset=True,
        ann_cfg=[dict(method='FSCE', setting='SPLIT1_SEED0_5SHOT')],
...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            # type='DISCRICosineSimBBoxHeadENERGY',
...
# load_from = 'work_dirs/fsce_r101_fpn_voc-split2_2shot-fine-tuning_seed0_energy_mixup/epoch_50.pth'
# load_from = 'work_dirs/fsce_r101_fpn_voc-split2_5shot-fine-tuning_seed0_energy_mixup/latest.pth'
load_from = 'work_dirs/fsce_r101_fpn_voc-split1_5shot-fine-tuning_seed0_mixing/epoch_50.pth'
