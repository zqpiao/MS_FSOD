...
data = dict(
    ...
    train=dict(
        ...
        save_dataset=True,
        ann_cfg=[dict(method='FSCE', setting='SPLIT2_SEED0_10SHOT')],
...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            # loss_energy_weight=0.0,
            loss_discri_weight=0.1,
...
log_level = 'INFO'
# load_from = 'work_dirs/fsce_r101_fpn_voc-split1_base-training/base_model_random_init_bbox_head.pth'
# load_from = 'work_dirs/fsce_r101_fpn_voc-split1_10shot-fine-tuning_seed0_energy_mixup/epoch_50.pth'
# load_from = 'work_dirs/fsce_r101_fpn_voc-split2_3shot-fine-tuning_seed0_energy_mixup/iter_5000.pth'
load_from = 'work_dirs/fsce_r101_fpn_voc-split2_10shot-fine-tuning_seed0_mixing/iter_5000.pth'
