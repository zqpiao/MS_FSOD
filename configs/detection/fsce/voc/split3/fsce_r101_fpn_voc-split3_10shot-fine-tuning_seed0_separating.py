...
data = dict(
    ...
    train=dict(
        ...
        save_dataset=True,
        ann_cfg=[dict(method='FSCE', setting='SPLIT3_SEED0_10SHOT')],
...
log_level = 'INFO'
# load_from = 'work_dirs/fsce_r101_fpn_voc-split1_10shot-fine-tuning_seed0_mixing/epoch_50.pth'
load_from = 'work_dirs/fsce_r101_fpn_voc-split3_10shot-fine-tuning_seed0_mixing/iter_8000.pth'
