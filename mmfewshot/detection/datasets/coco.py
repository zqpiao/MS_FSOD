...
# COCO_SPLIT = dict(
#     ALL_CLASSES=('bingdundun', 'Sanyo', 'Eifini', 'PSALTER', 'Beaster', 'ON', 'BYREDO', 'Ubras', 'Eternelle', 'PERFECT DIARY', 'huaxizi', 'Clarins', "L'occitane", 'Versace', 'Mizuno', 'Lining', 'DOUBLE STAR', 'YONEX', 'Tory Burch', 'Gucci', 'Louis Vuitton', 'CARTELO', 'JORDAN', 'KENZO', 'UNDEFEATED', 'BOY LONDON', 'TREYO', 'carhartt', 'jierou', 'Blancpain', 'GXG', 'leding', 'Diadora', 'TUCANO', 'Loewe', 'Granite Gear', 'DESCENTE', 'OSPREY', 'Swatch', 'erke', 'Massimo Dutti', 'PINKO', 'PALLADIUM', 'origins', 'Trendiano', 'yiner', 'Monster Guardians', 'fuerjia', 'IPSA', 'Schwarzkopf'),
#     NOVEL_CLASSES=('bingdundun', 'Sanyo', 'Eifini', 'PSALTER', 'Beaster', 'ON', 'BYREDO', 'Ubras', 'Eternelle', 'PERFECT DIARY', 'huaxizi', 'Clarins', "L'occitane", 'Versace', 'Mizuno', 'Lining', 'DOUBLE STAR', 'YONEX', 'Tory Burch', 'Gucci', 'Louis Vuitton', 'CARTELO', 'JORDAN', 'KENZO', 'UNDEFEATED', 'BOY LONDON', 'TREYO', 'carhartt', 'jierou', 'Blancpain', 'GXG', 'leding', 'Diadora', 'TUCANO', 'Loewe', 'Granite Gear', 'DESCENTE', 'OSPREY', 'Swatch', 'erke', 'Massimo Dutti', 'PINKO', 'PALLADIUM', 'origins', 'Trendiano', 'yiner', 'Monster Guardians', 'fuerjia', 'IPSA', 'Schwarzkopf'),
#     BASE_CLASSES=('bingdundun', 'Sanyo', 'Eifini', 'PSALTER', 'Beaster', 'ON', 'BYREDO', 'Ubras', 'Eternelle', 'PERFECT DIARY', 'huaxizi', 'Clarins', "L'occitane", 'Versace', 'Mizuno', 'Lining', 'DOUBLE STAR', 'YONEX', 'Tory Burch', 'Gucci', 'Louis Vuitton', 'CARTELO', 'JORDAN', 'KENZO', 'UNDEFEATED', 'BOY LONDON', 'TREYO', 'carhartt', 'jierou', 'Blancpain', 'GXG', 'leding', 'Diadora', 'TUCANO', 'Loewe', 'Granite Gear', 'DESCENTE', 'OSPREY', 'Swatch', 'erke', 'Massimo Dutti', 'PINKO', 'PALLADIUM', 'origins', 'Trendiano', 'yiner', 'Monster Guardians', 'fuerjia', 'IPSA', 'Schwarzkopf')
# )
...
class FewShotCocoDefaultDataset(FewShotCocoDataset):
    ...
    #     ]
    #     # for shot in [10, 30]
    #     for shot in [50]   ##TC_LOGO
    # }

    coco_benchmark = {
        f'{shot}SHOT_SEED{seed}': [
            dict(
                type='ann_file',
                ann_file=f'data/few_shot_ann/cocosplit/seed{seed}/'
                         f'full_box_{shot}shot_{class_name}_trainval.json')
            for class_name in COCO_SPLIT['ALL_CLASSES']
        ]
        # for shot in [10, 30]
        for shot in [10, 30] for seed in list(range(10))
    }
