...
class CosineSimBBoxHeadENERGY(ConvFCBBoxHead):
    ...
    def loss(self,
        ...
        #
        #         #out loss
        #         loss_energy +=  -(cls_score_novel[:, :base_num].mean(1) - torch.logsumexp(cls_score_novel[:, :base_num], dim=1)).mean()
        ...
        #
        #         loss_energy +=  -(cls_score_base[:, base_num:-1].mean(1) - torch.logsumexp(cls_score_base[:, base_num:-1], dim=1)).mean()
